...
/**
 * Curated catalog of public-domain / Creative Commons films from the
 * Internet Archive. These are the bundled fallback when TMDB_API_KEY is
 * absent, and are also used to enrich TMDB results with playable URLs.
 *
 * All streamUrls verified against archive.org as of authoring.
 */
export const SAMPLE_MOVIES: Movie[] = [
  ...
  },
  {
    ...
    title: 'The General',
    year: 1926,
    description: 'Buster Keaton silent action comedy considered one of the greatest films ever made.',
  ...
  },
  {
    ...
    year: 1940,
    description: 'Howard Hawks screwball comedy about a fast-talking newspaper editor and his ex-wife.',
  ...
  },
  {
    ...
    streamUrl: 'https://archive.org/download/Plan9FromOuterSpace_215/Plan%209%20from%20Outer%20Space.mp4',
    runtimeMinutes: 79,
